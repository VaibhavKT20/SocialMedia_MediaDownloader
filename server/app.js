...
const MONGO_CONNECT = `mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_PASS}@cluster0.u8kumnk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
const PORT_NO = "3030";
